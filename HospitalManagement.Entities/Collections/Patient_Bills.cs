...
namespace HospitalManagement.Entities.Collections
{
    ...
    /// </summary>
   public  class Patient_Bills: CollectionBase<Patient_Bill>
    {
       /// <summary>
    ...
    public Patient_Bills(IList<Patient_Bill> initialList) : base(initialList) { }

    /// <summary>
    /// Initializes a new instance of the <see cref="Patients"/> class.
    /// </summary>
    /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
    public Patient_Bills(CollectionBase<Patient_Bill> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var patient_bill in this)
      {
        errors.AddRange(patient_bill.Validate());
      }
      return errors;
    }
    }
